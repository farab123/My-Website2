...
define('SKT_GARDENING_LITE_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/gardening-documentation/');
define('SKT_GARDENING_LITE_SKTTHEMES_LIVE_DEMO','http://sktthemesdemo.net/gardening/');
